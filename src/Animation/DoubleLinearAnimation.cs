...
namespace Animation
{
    public class DoubleLinearAnimation : AnimationBase, ILinearAnimation
    {
        ...
        public DoubleLinearAnimation() { }

        public DoubleLinearAnimation(string name)
            : this()
        {
            this.Name = name;
        }
        ...
        public double Current
        {
            get
            {
                return this.m_keyFrames[this.FrameIndex];
            }
        }
